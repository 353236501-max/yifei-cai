...
// Local tutor debugging needs outbound model calls; API routes still enforce
// HTTPS allowlists and redirect:'error'. Production Sites controls its own fetch.
process.env.CLOUDFLARE_CF_FETCH_ENABLED ||= "true";
